		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Emp App",
									"targetURL": "#empappuiempappui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"empappuiempappui-display": {
								"semanticObject": "empappuiempappui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=empappui.empappui",
									"url": sap.ui.require.toUrl("empappui/empappui")
								}
							}
						}
					}
